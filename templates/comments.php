  ...
  <section id="respond">
    ...
    <?php else : ?>
      <form action="<?php echo get_option('siteurl'); ?>/wp-comments-post.php" method="post" id="commentform">
        ...
        <?php else : ?>
          <div class="comment-left alignleft">
	...
	<label for="email"><?php _e('Email* (will not be published)', 'roots'); ?></label>
	...
	<input type="url" class="text" name="url" id="url" value="<?php echo esc_attr($comment_author_url); ?>" size="22">
        ...
        <?php endif; ?>
				<div class="comment-right alignleft">
					<label for="comment"><?php _e('Comment', 'roots'); ?></label>
					<textarea name="comment" id="comment" class="input-xlarge" rows="5" aria-required="true"></textarea>
					<p><input name="submit" class="btn" type="submit" id="submit" value="<?php _e('Submit Comment', 'roots'); ?>"></p>
				</div>
